...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/cv_hwaranlee_240706.pdf";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-joined-sogang-university-in-the-department-of-artificial-intelligence-and-computer-science-amp-amp-engineering-in-seoul",
          title: 'I joined Sogang University in the Department of Artificial Intelligence and Computer Science...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.semanticscholar.org/author/2294014# your Semantic Scholar ID", "_blank");
        },
      },{
      id: 'light-theme',
