...
###### **[C3] [Compositional Sentence Representation from Character within Large Context Text](https://link.springer.com/chapter/10.1007/978-3-319-70096-0_69)**
  ...
  * *International Conference on Neural Information Processing **(ICONIP)**,  2017.* \| [`pdf`](https://arxiv.org/pdf/1605.00482.pdf) \| `Oral`
...
###### **[C2] [Hierarchical committee of deep CNNs with exponentially-weighted decision fusion for static facial expression recognition](https://dl.acm.org/citation.cfm?id=2830590)**
  ...
  * *International Conference on Multimodal Interaction **(ICMI)**, 2015.* \| [`demo`](https://youtu.be/UG-M8aOX-gY) \| `Challenge Winner` \| `Oral`
...
###### **[C1] [Active Learning for Large-scale Object Classification: from Exploration to Exploitation](https://dl.acm.org/citation.cfm?id=2814989)**
  ...
  * *In Proceedings of the 3rd International Conference on Human-Agent Interaction **(HAI)**, 2015.* \| `Best paper` \| `Qualcomm Innovation Awards`
...
###### **[W2] [Learning Tonotopically Organized Auditory Feature-map from Speech by an Intermap Pooling Layer in a Deep CNN]("NBNI2015_abstract_hwaran.pdf")**
  ...
  * *China-Japan-Korea Joint Workshop on Neurobioloby and Neuroinformatics **(NBNI)**, 2015*. *(only abstract)* \| [`pdf`](NBNI2015_abstract_hwaran.pdf)
...
###### **[W1] [Spoken Sentence Embedding from Character by Jointly Learning Character-level Compositional Word Model and RNN Sentence Encoder](NBNI2015_abstract_geonmin.pdf)**
  ...
  * *China-Japan-Korea Joint Workshop on Neurobioloby and Neuroinformatics **(NBNI)**, 2015*. *(only abstract)* \| [`pdf`](NBNI2015_abstract_geonmin.pdf)
